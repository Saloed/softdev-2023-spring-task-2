...
public class DuTest {
    ...
    @Test
    public void test1(){
        List<String> fileList = Arrays.asList(Paths.get("Inputs", "File1").toString().replace("\\", "/"),
    ...
    public void test2(){
        List<String> fileList = Arrays.asList(Paths.get("Inputs", "File1").toString().replace("\\", "/"),
                Paths.get("Inputs", "File2").toString().replace("\\", "/"),
                Paths.get("Inputs", "File3").toString().replace("\\", "/"));
    ...
    @Test
    public void test3(){
        List<String> fileList = Arrays.asList(Paths.get("Inputs", "File2").toString().replace("\\", "/"),
                Paths.get("Inputs", "File1").toString().replace("\\", "/"),
                Paths.get("Inputs", "File3").toString().replace("\\", "/"));
        Functions functions = new Functions(new Explorer(fileList).makingLongArrayList(), true, false, true);
        Assertions.assertEquals("""
                124,36KB
