...
public class DuTest {
    ...
    @Test
    public void test1(){
        List<String> fileList = Arrays.asList("Inputs" + File.separator + "File1",
                "Inputs" + File.separator + "File2",
                "Inputs" + File.separator + "File3");
    ...
    @Test
    public void test3(){
        List<String> fileList = Arrays.asList("Inputs" + File.separator + "File2",
                "Inputs" + File.separator + "File1",
                "Inputs" + File.separator + "File3");
        Functions functions = new Functions(new Explorer(fileList).makingLongArrayList(), true, false, true);
